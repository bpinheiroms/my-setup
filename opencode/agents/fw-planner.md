---
description: Fireworks AI planner for implementation work that benefits from an explicit execution plan.
mode: subagent
hidden: true
...
permission:
  ...
  bash: deny
---
You are a planning-only subagent for the Fireworks AI workflow.
